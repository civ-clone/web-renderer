...
i18next.addResources(
  ...
  'default',
  {
    ...
    'Generic.no': 'No',
    'Generic.ok': 'OK',
    'Generic.city-name': '$t({{civilization}}.{{- name}}.name, { "defaultValue": "{{name}}", "ns": "city" })',
    'Generic.civilization-name.name': '$t({{- civilization}}.name, { "defaultValue": "{{player.civilization._}}", "ns": "civilization" })',
    'Generic.civilization-name.nation': '$t({{- civilization}}.nation, { "defaultValue": "{{player.civilization._}}", "ns": "civilization" })',
    'Generic.civilization-name.plural': '$t({{- civilization}}.plural, { "defaultValue": "{{player.civilization._}}", "ns": "civilization" })',
    'Generic.leader-name': '$t(Leader.{{- leader}}.name, { "defaultValue": "{{player.civilization.leader._}}", "ns": "civilization" })',
    'Generic.view-city': 'View $t(Generic.city-name, { "name": "{{city.name}}", "civilization": "{{city.originalPlayer.civilization._}}", "ns": "default" })',
    'Generic.width': 'Width',
    'Generic.yes': 'Yes',
    ...
    'Actions.CityBuildSelectionWindow.title': 'What would you like to build in $t(Generic.city-name, { "name": "{{city.name}}", "civilization": "{{city.originalPlayer.civilization._}}", "ns": "default" })?',

    'Actions.CivilDisorder.body': 'Civil disorder in $t(Generic.city-name, { "name": "{{city.name}}", "civilization": "{{city.originalPlayer.civilization._}}", "ns": "default" }), mayor flees in panic!',
    'Actions.CivilDisorder.title': 'Civil disorder in $t(Generic.city-name, { "name": "{{city.name}}", "civilization": "{{city.originalPlayer.civilization._}}", "ns": "default" })!',
    ...
    'Actions.ShowCity.label': '$t(Generic.view-city, { "name": "{{city.name}}", "civilization": "{{city.originalPlayer.civilization._}}" })',
    ...
    'Actions.Spaceship.inactive-part': '({{inactiveParts, number}} inactive)',
    ...
    'Actions.Spaceship.spaceship-name': '$t(Generic.civilization-name.name, { "civilization": "{{player.civilization._}}", "ns": "default" }) spaceship',
    'Actions.Spaceship.title': 'View spaceship',

    'Buildable.label-empty': `Nothing`,

    'ChooseFromList.choose-civilization.body': '',
    'ChooseFromList.choose-civilization.choice': '$t(Generic.civilization-name.name, { "civilization": "{{value._}}", "ns": "default" })',
    'ChooseFromList.choose-civilization.title': 'Choose your civilization',
    'ChooseFromList.choose-leader.body': '',
    'ChooseFromList.choose-leader.choice': '$t(Generic.leader-name, { "leader": "{{value._}}", "ns": "default" })',
    ...
    'ChooseFromList.negotiation.next-step.title': 'Negotiation between $t(Generic.civilization-name.nation, { "civilization": "{{data.players.0.civilization._}}", "ns": "default" }) and $t(Generic.civilization-name.nation, { "civilization": "{{data.players.1.civilization._}}", "ns": "default" })',
    ...
    'CityStatus.build_nonempty': '$t(CityStatus.totals, { "free": {{free}}, "total": {{total}}, "context": "{{totals_context}}" }) {{buildable}} $t(Progress.data, { "progress": {{build.progress.value}}, "total": {{build.cost.value}} }) ($t(Progress.turns, { "count": {{turns}} }))',
    ...
    'CustomizeWorld.max-iterations': 'Max iterations',
    ...
    'HappinessReport.view-city': '$t(Generic.view-city, { "name": "{{city.name}}", "civilization": "{{city.originalPlayer.civilization._}}" })',
    ...
    'Welcome.you-have-risen': '$t(Generic.leader-name, { "leader": "{{player.civilization.leader._}}", "ns": "default" }), you have risen to become leader of the $t(Generic.civilization-name.nation, { "civilization": "{{player.civilization._}}", "ns": "default" }).',
...
i18next.addResources('en', 'notification', {
    ...
    'City.building-complete.unit.body': '$t(Generic.city-name, { "civilization": "{{cityBuild.city.originalPlayer.civilization._}}", "name": "{{cityBuild.city.name}}", "ns": "default" }) has completed work on $t({{build._}}.name, { "defaultValue": "{{build._}}", "ns": "unit" })!',
    'City.building-complete.unit.title': 'Building complete!',
    'City.building-complete.city-improvement.body': '$t(Generic.city-name, { "civilization": "{{cityBuild.city.originalPlayer.civilization._}}", "name": "{{cityBuild.city.name}}", "ns": "default" }) has completed work on $t(Improvement.{{build._}}.name, { "defaultValue": "{{build._}}", "ns": "city" })!',
    'City.building-complete.city-improvement.title': 'Building complete!',
    'City.building-complete.wonder.body': '$t(Generic.city-name, { "civilization": "{{cityBuild.city.originalPlayer.civilization._}}", "name": "{{cityBuild.city.name}}", "ns": "default" }) has completed work on $t({{build._}}.name, { "defaultValue": "{{build._}}", "ns": "wonder" })!',
    'City.building-complete.wonder.title': 'Building complete!',
    'City.building-complete.spaceship-part.body': '$t(Generic.city-name, { "civilization": "{{cityBuild.city.originalPlayer.civilization._}}", "name": "{{cityBuild.city.name}}", "ns": "default" }) has completed work on $t({{build._}}.name, { "defaultValue": "{{build._}}", "ns": "spaceship" })!',
    'City.building-complete.spaceship-part.title': 'Building complete!',
    'City.building-complete.other.body': '$t(Generic.city-name, { "civilization": "{{cityBuild.city.originalPlayer.civilization._}}", "name": "{{cityBuild.city.name}}", "ns": "default" }) has completed work on its build project!',
    'City.building-complete.other.title': 'Building complete!',
    'City.captured-by-us.body': 'We have captured $t(Generic.city-name, { "civilization": "{{city.originalPlayer.civilization._}}", "name": "{{city.name}}", "ns": "default" }) from $t({{originalPlayer.civilization._}}.nation, { "defaultValue": "{{originalPlayer.civilization._}}", "ns": "civilization" })',
    'City.captured-by-us.title': 'City captured!',
    'City.captured-from-us.body': '$t({{capturingPlayer.civilization._}}.nation, { "defaultValue": "{{capturingPlayer.civilization._}}", "ns": "civilization" }) have captured our city $t(Generic.city-name, { "civilization": "{{city.originalPlayer.civilization._}}", "name": "{{city.name}}", "ns": "default" })!',
    'City.captured-from-us.title': 'City captured!',
    'City.civil-disorder.body': `Civil disorder in $t(Generic.city-name, { "civilization": "{{city.originalPlayer.civilization._}}", "name": "{{city.name}}", "ns": "default" }). Mayor flees in panic!`,
    'City.civil-disorder.title': 'Civil disorder',
    'City.leader-celebration.body': `Leader celebration in $t(Generic.city-name, { "civilization": "{{city.originalPlayer.civilization._}}", "name": "{{city.name}}", "ns": "default" })!`,
    'City.leader-celebration.title': 'Leader celebration',
    'City.leader-celebration-ended.body': `Leader celebration cancelled in $t(Generic.city-name, { "civilization": "{{city.originalPlayer.civilization._}}", "name": "{{city.name}}", "ns": "default" })!`,
    'City.leader-celebration-ended.title': 'Leader celebration',
    'City.order-restored.body': `Order restored in $t(Generic.city-name, { "civilization": "{{city.originalPlayer.civilization._}}", "name": "{{city.name}}", "ns": "default" }).`,
    'City.order-restored.title': 'Order restored!',
    'City.shrink.body': `Population decrease in $t(Generic.city-name, { "civilization": "{{city.originalPlayer.civilization._}}", "name": "{{city.name}}", "ns": "default" }).`,
    'City.shrink.title': 'Population decrease!',
    'City.unit-unsupported.body': `$t(Generic.city-name, { "civilization": "{{city.originalPlayer.civilization._}}", "name": "{{city.name}}", "ns": "default" }) cannot support $t({{unit._}}.name, { "defaultValue": "{{unit._}}", "ns": "unit" }).`,
    'City.unit-unsupported.title': 'Unit not supported!',
    'City.improvement-unsupported.body': `$t(Generic.city-name, { "civilization": "{{city.originalPlayer.civilization._}}", "name": "{{city.name}}", "ns": "default" }) cannot support $t(Improvement.{{cityImprovement._}}.name, { "defaultValue": "{{cityImprovement._}}", "ns": "city" }).`,
    ...
    'Player.declaration-expired.body': 'Our $t(Declaration.{{declaration._}}, { "defaultValue": "{{declaration._}}", "ns": "diplomacy" }) with $t(Generic.civilization-name.nation, { "civilization": "{{enemy.civilization._}}", "ns": "default" }) has been cancelled!',
    'Player.declaration-expired.title': 'Sneak attack by $t(Generic.civilization-name.nation, { "civilization": "{{enemy.civilization._}}", "ns": "default" })!',
    'Player.defeated.by.body': '$t(Generic.civilization-name.nation, { "civilization": "{{player.civilization._}}", "ns": "default" }) has defeated $t(Generic.civilization-name.nation, { "civilization": "{{defeatedPlayer.civilization._}}", "ns": "default" })!',
    'Player.defeated.by.title': 'Defeated!',
    'Player.defeated.local.body': 'You have been defeated by $t(Generic.civilization-name.nation, { "civilization": "{{player.civilization._}}", "ns": "default" })!',
    ...
    'Spaceship.part-built.body': 'Component added to $t(Generic.civilization-name.nation, { "civilization": "{{player.civilization._}}", "ns": "default" }) spaceship.',
    'Spaceship.part-built.title': 'Spaceship built',

    'Wonder.building-complete.other-player.known.body': '$t(Generic.city-name, { "city": {{city}} }) has completed work on $t({{build._}}.name, { "defaultValue": "{{build._}}", "ns": "wonder" })!',
