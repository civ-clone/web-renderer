...
// Runs tests/engine/inject.ts — the Stage 4 acceptance check from
// docs/engine-serialisation/05-engine-plan.md: "the generic-inject spike
...
require('esbuild').buildSync({
  entryPoints: [path.join(webRenderer, 'tests', 'engine', 'inject.ts')],
  bundle: true,
  keepNames: true,
  platform: 'node',
  format: 'cjs',
